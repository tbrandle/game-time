...
function levels() {
  ...
  if (level === 1) {
    // obj
    // createFirstRow({num: 3, xStart: -100, spacing: 130, yStart: 10, height: 15, counter: 1});
    // createSecondRow({num: 3, xStart: 0, spacing: 80, yStart: 30, height: 15, counter: 1});
...
function levelPass() {
  ...
  if (blockHeight === true && level < 1 && level >= 0) {
    level++;
  ...
  } else if (blockHeight === true && level === 1) {
